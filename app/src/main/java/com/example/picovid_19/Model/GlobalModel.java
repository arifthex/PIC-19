...
public class GlobalModel {
    //Mengambil API dengan menggunakan serialized JSON
    ...
    public GlobalModel(String lastUpdate, Confirmed confirmed, Deaths deaths, Recovered recovered) {
