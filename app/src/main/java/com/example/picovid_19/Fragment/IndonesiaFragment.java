...
import com.example.picovid_19.viewmodel.IndonesiaViewModel;
...
public class IndonesiaFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        PieChart pieChart = view.findViewById(R.id.idnPie);
        ...
        viewModel.getCountryData().observe(this, new Observer<IndonesiaModel>() {
            ...
            public void onChanged(IndonesiaModel indonesiaModel) {
                ...
                pieEntries.add(new PieEntry(indonesiaModel.getIdnConfirmed().getValue(), getResources().getString(R.string.confirmed)));
                pieEntries.add(new PieEntry(indonesiaModel.getIdnDeaths().getValue(), getResources().getString(R.string.deaths)));
                pieEntries.add(new PieEntry(indonesiaModel.getIdnRecovered().getValue(), getResources().getString(R.string.recovered)));
                ...
                description.setText(getResources().getString(R.string.last_update) + " : " + indonesiaModel.getLastUpdate());
